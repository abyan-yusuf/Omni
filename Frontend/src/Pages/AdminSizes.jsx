                          ...
                          try {
                            ...
                            if (confirm) {
                              const { data } = await axios.delete(
                                `https://backend.omnishoesbd.com/api/v1/sizes/delete/${size._id}`,
                                {
          ...
          onSubmit={async (e) => {
            ...
            try {
              const { data } = await axios.post(
                "https://backend.omnishoesbd.com/api/v1/sizes/create",
                {
          ...
          onSubmit={async (e) => {
            ...
            try {
              const { data } = await axios.put(
                `https://backend.omnishoesbd.com/api/v1/sizes/update/${updateSize.id}`,
                {
                  size: e.target.size.value,
                },
                { headers: { Authorization: auth?.token } }
