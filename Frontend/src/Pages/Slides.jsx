          ...
          <div className="grid grid-cols-2 gap-8">
            {slides.map((slide) => (
              <div className="relative group">
                <button className="w-full h-full hidden bg-[rgba(0,0,0,0.5)] z-10 cursor-pointer group-hover:block absolute" onClick={() => handleDelete(slide._id)}>
